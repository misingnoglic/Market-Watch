...
class StockHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create stock_history" do
    assert_difference('StockHistory.count') do
      post :create, stock_history: { last_trade_price: @stock_history.last_trade_price, stock_symbol: @stock_history.stock_symbol }
    end
  ...
  test "should update stock_history" do
    patch :update, id: @stock_history, stock_history: { last_trade_price: @stock_history.last_trade_price, stock_symbol: @stock_history.stock_symbol }
    assert_redirected_to stock_history_path(assigns(:stock_history))
  end
