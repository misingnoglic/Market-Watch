...
class RulesController < ApplicationController
  ...
  def create
    ...
    params[:rule][:lastfired] = 1.year.ago.utc #default minimum, updates to new time on firing
  ...
  private
    ...
    def rule_params
      params.require(:rule).permit(:target_price, :user_id, :stock_id, :stock_symbol, :lastfired, :compare)
    end
end
